    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Dialog open={createOpen} onOpenChange={(v) => { setCreateOpen(v); if (!v) resetForm() }}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader><DialogTitle>Nova regra recorrente</DialogTitle></DialogHeader>
            {formFields}
      ...
      {items.length === 0 ? (
        <div className="text-center py-16">
          <Repeat className="h-10 w-10 mx-auto text-muted-foreground/30" />
          <p className="text-muted-foreground mt-3">Nenhuma regra recorrente</p>
