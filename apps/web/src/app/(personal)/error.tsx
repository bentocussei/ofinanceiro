...
export default function PersonalError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4">
      <h2 className="text-2xl font-bold text-destructive">Erro</h2>
      <p className="mt-3 text-sm text-muted-foreground max-w-md text-center">{error.message || "Erro ao carregar esta página."}</p>
